...
<head>
    ...
    <title>PHP OOP MVC Tutorials</title>
    <style>
        ...
        .footeroption{height: auto;background:#177de3;overflow:hidden;padding-top:10px;text-align: center;display: flex;justify-content: center;}
        .footerone {background: #3aa0ff;border-radius: 5px;font-size:18px;width: 350px;text-shadow: 1px 0 2px #fff;}
        .footerone p{padding-bottom: 10px;}
    </style>
</head>
<body>
